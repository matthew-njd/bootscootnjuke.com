    ...
    <div className="flex flex-col items-center">
      ...
      <div className="mt-24">
        <Podium
          ...
          firstPlace={{
            ...
            details: (
              <>
                Team: {highestWeekTotal[0].team || "TBD"}<br />
                Owner: {highestWeekTotal[0].owner || "TBD"}<br />
                Year: {highestWeekTotal[0].year || 0}<br />
          ...
          secondPlace={{
            ...
            details: (
              <>
                Team: {highestWeekTotal[1].team || "TBD"}<br />
                Owner: {highestWeekTotal[1].owner || "TBD"}<br />
                Year: {highestWeekTotal[1].year || 0}<br />
          ...
          thirdPlace={{
            ...
            details: (
              <>
                Team: {highestWeekTotal[2].team || "TBD"}<br />
                Owner: {highestWeekTotal[2].owner || "TBD"}<br />
                Year: {highestWeekTotal[2].year || 0}<br />
      ...
      <div className="mt-24">
        <Podium
          ...
          firstPlace={{
            stat: `${highestPlayerTotal[0].points || 0}, ${highestPlayerTotal[0].player || "TBD"}`,
            details: (
              <>
                Team: {highestPlayerTotal[0].team || "TBD"}<br />
                Owner: {highestPlayerTotal[0].owner || "TBD"}<br />
                Year: {highestPlayerTotal[0].year || 0}
              </>
            ),
          }}
          secondPlace={{
            stat: `${highestPlayerTotal[1].points || 0}, ${highestPlayerTotal[1].player || "TBD"}`,
            details: (
              <>
                Team: {highestPlayerTotal[1].team || "TBD"}<br />
                Owner: {highestPlayerTotal[1].owner || "TBD"}<br />
                Year: {highestPlayerTotal[1].year || 0}
              </>
            ),
          }}
          thirdPlace={{
            stat: `${highestPlayerTotal[2].points || 0}, ${highestPlayerTotal[2].player || "TBD"}`,
            details: (
              <>
                Team: {highestPlayerTotal[2].team || "TBD"}<br />
                Owner: {highestPlayerTotal[2].owner || "TBD"}<br />
      ...
      <div className="mt-24">
        <Podium
          ...
          firstPlace={{
            ...
            details: (
              <>
                Team: {highestSeasonTotal[0].team || "TBD"}<br />
                Owner: {highestSeasonTotal[0].owner || "TBD"}<br />
          ...
          secondPlace={{
            ...
            details: (
              <>
                Team: {highestSeasonTotal[1].team || "TBD"}<br />
                Owner: {highestSeasonTotal[1].owner || "TBD"}<br />
          ...
          thirdPlace={{
            ...
            details: (
              <>
                Team: {highestSeasonTotal[2].team || "TBD"}<br />
                Owner: {highestSeasonTotal[2].owner || "TBD"}<br />
